...
function getLeviathanData() {
    return [
        ...
        leviathanCard("Ragnar", "Viking", 2, "scandinavian", 210),
        leviathanCard("Ulfbert", "Viking", 2, "scandinavian", 220),
        leviathanCard("Aland", "Baltishka", 1, "scandinavian", 180),
        leviathanCard("Gotland", "Baltishka", 1, "scandinavian", 160),
        leviathanCard("Speer", "Konigsberg", 2, "swiss", 220),
        leviathanCard("Morgenstern", "Konigsberg", 2, "swiss", 230),
        leviathanCard("Shwert", "Falke", 1, "swiss", 180),
...
function addToFleet(item) {
    ...
    currentFleet.sort((a,b) => a.points == b.points ? a.name.localeCompare(b.name) : b.points - a.points);
    updateCurrentFleet();
}
