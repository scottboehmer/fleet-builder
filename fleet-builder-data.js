...
const levData = sortByPointsAndName([
    ...
    leviathanCard("HML Leviathan", "Leviathan", 4, "british", 420, ["Leviathan Battleship Pack"]),
    leviathanCard("HML Medusa", "Leviathan", 4, "british", 430, ["Leviathan Battleship Pack"]),
    ...
    leviathanCard("HML Spion Kop", "Defender", 3, "british", 320, ["Defender Battlecruiser Pack"]),
    leviathanCard("HML Mafeking", "Defender", 3, "british", 340, ["Defender Battlecruiser Pack"]),
    ...
    leviathanCard("HML New Zealand", "County", 2, "british", 200, ["County Cruiser Pack"]),
    leviathanCard("HML Essex", "County", 2, "british", 170, ["County Cruiser Pack"]),
    leviathanCard("HML Anfield", "D-Class", 1, "british", 160, ["British Fleet Box"]),
    leviathanCard("HML Beagle", "D-Class", 1, "british", 170, ["British Fleet Box"]),
    leviathanCard("HML Dublin", "D-Class", 1, "british", 180, ["British Fleet Box"]),
    leviathanCard("HML Belfast", "D-Class", 1, "british", 150, ["British Fleet Box"]),
    leviathanCard("HML Crow", "D-Class", 1, "british", 150, ["D-Class Destroyer Pack"]),
    leviathanCard("HML Raven", "D-Class", 1, "british", 160, ["D-Class Destroyer Pack"]),
    ...
    leviathanCard("Paris", "Paris", 4, "french", 460, ["Paris Battleship Pack"]),
    leviathanCard("Jean Bart", "Paris", 4, "french", 400, ["Paris Battleship Pack"]),
    ...
    leviathanCard("Bearn", "Conquent", 3, "french", 320, ["Conquent Battlecruiser Pack"]),
    leviathanCard("Ardent", "Conquent", 3, "french", 300, ["Conquent Battlecruiser Pack"]),
    ...
    leviathanCard("Lave", "Liberte", 2, "french", 200, ["Liberte Cruiser Pack"]),
    leviathanCard("Pontbriand", "Liberte", 2, "french", 250, ["Liberte Cruiser Pack"]),
    ...
    leviathanCard("La Gloire", "Grenouille", 1, "french", 170, ["Starter Box"]),
    leviathanCard("Aquitaine", "Grenouille", 1, "french", 170, ["Starter Box"]),
    leviathanCard("Normandie", "Grenouille", 1, "french", 170, ["French Fleet Box"]),
    leviathanCard("La Honneur", "Grenouille", 1, "french", 180, ["French Fleet Box"]),
    leviathanCard("Pelletier", "Grenouille", 1, "french", 170, ["French Fleet Box"]),
    leviathanCard("Montcalm", "Grenouille", 1, "french", 160, ["French Fleet Box"]),
    leviathanCard("Montpellier", "Grenouille", 1, "french", 180, ["Grenouille Destroyer Pack"]),
    leviathanCard("Grenadier", "Grenouille", 1, "french", 160, ["Grenouille Destroyer Pack"]),
